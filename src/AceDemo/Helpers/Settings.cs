...
namespace AceDemo.Helpers
{
    ...
    public static class Settings
    {
        ...
        /// <summary>
        ///     Retrieves the entry value for the following composed key: "config:ProjectVersion" as a string.
        /// </summary>
        public static readonly string ProjectVersion = GetValue<string>("ProjectVersion");

        /// <summary>
        ///     Retrieves the entry value for the following composed key: "config:CopyRight" as a string.
        /// </summary>
        ...
        /// </summary>
        public static readonly string CurrentTheme = GetValue<string>("Theme");
