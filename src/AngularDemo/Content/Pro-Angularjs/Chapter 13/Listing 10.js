...
//    $scope.reverseText = function () {
//        $scope.dataValue = $scope.dataValue.toUpperCase() + '[TOP]';
//    }
...
//                ? char.toString().toUpperCase() : char.toString().toLowerCase());
//        });
//        $scope.dataValue = result.join("")  + '[TOP]';
//    };
//});
...
//    $scope.changeCase = function () {
//        $scope.dataValue = $scope.dataValue.toUpperCase() + '[C1]';
//    };
//});
...
//    $scope.changeCase = function () {
//        $scope.dataValue = $scope.dataValue.toUpperCase() + '[C2]';
//    };
...
//            result.push(index < 4 ? char.toUpperCase() : char);
//        });
//        $scope.dataValue = result.join("") + '[C2]';
//    }
//});
