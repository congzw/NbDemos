...
namespace ZQNB.Common.Extensions
{
    ...
    {
        //正则这块 参考 https://github.com/quocdunginfo/QuanLyTaiSan/blob/master/SHARED/Libraries/MobileDetect.cs
        ...
        {
            var isMobile = httpRequest.QueryString["mobile"];
            if (!string.IsNullOrEmpty(isMobile) && isMobile.Equals("true", StringComparison.CurrentCultureIgnoreCase))
            {
                return true;
            }
